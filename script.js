//  favourites meal array if its not exist in local storage
...
// show's all meals card in main acording to search input value
            ...
            <div class="page-wrap d-flex flex-row align-items-center">
              <div class="container">
                    ...
                    <div class="col-md-12 text-center">
                     ...
                     <div class="mb-4 lead">
                                The meal you are looking for was not found..Please match your prefernces with our menu
                            </div>
                        </div>
                    </div>
                </div>
...
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.splice(number, 1);
        alert("your meal was removed from your favourites list");
    } 
    else {
        arr.push(id);
        alert("your meal was added to your favourites list");
    }
